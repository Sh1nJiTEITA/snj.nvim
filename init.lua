...
do
	...
	do
		...
		man.add_plugin({ file = "cmini" })
		man.add_plugin({ file = "ctelescope" })
		man.add_plugin({ file = "ctheme" })

		man.add_plugin({ file = "cyazi" })
		man.add_plugin({ file = "clsp" })
		man.add_plugin({ file = "cblinkcmp" })
